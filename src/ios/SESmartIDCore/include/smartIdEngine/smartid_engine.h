...
public:
  ...
  /**
  * @brief Get list of enabled string fields for document type
  */
  const std::map<std::string, std::vector<std::string> >&
      GetEnabledStringFieldNames() const;

  /**
  * @brief Enable string fields by name
  * @param doctype - type of document
  * @param string_field_name - name of string field
  */
  void EnableStringField(const std::string& doctype, 
      const std::string& string_field_name);
  /**
  * @brief Disable string fields by name
  * @param doctype - type of document
  * @param string_field_name - name of string field
  */
  void DisableStringField(const std::string& doctype, 
      const std::string& string_field_name);

  /**
  * @brief Set(modify) an enabled string fields by names
  * @param doctype - type of document
  * @param string_field_names - list of string field names
  */
  void SetEnabledStringFields(const std::string& doctype,
      const std::vector<std::string>& string_field_names);
...
protected:
  ...
  std::map<std::string, std::vector<std::string> > supported_fields_;
  std::map<std::string, std::vector<std::string> > enabled_fields_;
